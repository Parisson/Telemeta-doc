...
Institut Jean Le Rond d'Alembert, \\
 ...
 %\url{{thomas.fillon,guillaume.pellerin}@parisson.com}}
  {\normalsize Guillaume Pellerin, Paul Brossier} {
    PARISSON \\
    {\tt guillaume.pellerin@parisson.com}}
  {\normalsize Jos{\'e}phine Simonnot} {CREM, LESC, \\UMR CNRS 7186\\ MAE, Université Paris\\ Ouest Nanterre La Défense
{\tt %josephine.simonnot@mae.u-paris10.fr
}\thanks{This work is partly supported by a grant from the french National Research Agency (ANR) with reference ANR-12-CORD-0022.}}
...
The positive impact of this platform on ethnomusicological research has been describe in several publications \citep{Simmonot_IASA_2011, Julien_IASA_2011, Simonnot_ICTM_2014}.

Recently, an open-source audio analysis framework, \emph{Timeside}, has been developed to bring automatic music analysis capabilities to the web platform and thus have turned Telemeta into a unique resource for \emph{Computational Ethnomusicology} \citep{Tzanetakis_2007_JIMS, Gomez_JNMR_2013}
