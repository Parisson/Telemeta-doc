...
\title[Plénière DIADEMS 2014]{DIADEMS – Réunion plénière T0+18}
...
\date{IRIT, Toulouse - 20 juin 2014}        
...
\url{http://www.cmpe.boun.edu.tr/fma2014/}
  \end{itemize}
\end{block}
\begin{block}{A venir -> cf prochain transparent}
  \begin{itemize}
...
\begin{frame}\frametitle{Papier(s) DLFM}
  \begin{block}{Contraintes}\footnotesize
    \begin{itemize}
    \item full papers (up to 8 pages) or 
    \item position papers (up to 3 pages)
    \item \alert{Paper submission deadline: 27th June 2014 !!!!!}
    \end{itemize}

  \end{block}
  \begin{block}{Article(s) Diadems :  Que fait-on ? Qui ?}
          \begin{itemize}
      \item 1 papier ``Telemeta'' sur la base de publications précédentes (Full papers ?)
        \begin{itemize}\footnotesize
        \item Description du projet Telemeta
        \item Outil collaboratif, apport pour les chercheurs, documentaliste en ethnomusicologie, valorisation des archives
        \item Outil collaboratif pour l'annotation et le travail en commun + ``retour au pays''
        \end{itemize}

      \item ? +1 papier ``Diadems'' (full paper ou position paper ?)
        \begin{itemize}\footnotesize
        \item Orientation Diadems collaboration ethno <-> ``Informaticien``
        \item Apport de l'approche ``computationnelle'' pour l'ethnomusicologie
        \item Définition d'un langage commun et de problématiques pertinentes
        \item thesaurus, évaluation des résultats pour un outil d'aide aux sciences humaines
        \item TimeSide
        \end{itemize}
      \end{itemize}
