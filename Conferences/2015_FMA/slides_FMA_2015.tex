...
\begin{frame}\frametitle{Introduction}
 \begin{block}{Context}
   \begin{itemize}
    \item Digital age: quantization, duplication > tons of data!
    \item Network age: social networks, mutualization of resources
    \item Open and sutainable knowledge: languages, formats, standards, licenses, open source
   \end{itemize}

\begin{block}{Challenges}
   \begin{itemize}
    \item musicologists need music, metadata and queries
    \item computer music scientists need music datasets and semantics
    \item grow and scale data and tools over the web
   \end{itemize}
\end{block}
...
\begin{frame}[label=telemeta_features]{Web audio content management features and architecture}
  \begin{block}{Main features of Telemeta}\footnotesize
    \begin{itemize}
      ...
      \item \alert{High level search engine} \hyperlink{geonavigator}{geolocation}, instruments, ethnic groups, etc...).
