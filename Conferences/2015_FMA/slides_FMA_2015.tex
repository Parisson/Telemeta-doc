...
\begin{frame}{Ongoing developments}
  \begin{block}{Data analysis for the web}
    \begin{itemize}
    \item New analyzers from the \emph{Diadems} project
    \item Advance data representations for the web: D3.js, WAVES.js (IRCAM)
    \item Zoom capabilities 
    \item Online management and design of computational tasks 
...
\begin{frame}{Conclusion}
  \begin{block}{}
    \begin{itemize}[<+->]
    \item The Sound archives platform of the CNRS - Musée de l’Homme
    ...
    \item Telemeta and TimeSide are \alert{fully operational} web audio frameworks
      for managing digital sound archives in ethnomusicology context
...
\begin{frame}{Conclusion}
  \begin{block}{Telemeta: future developments}
    \begin{itemize}
    ...
    \item an \alert{interdisciplinary} collaborative platform between IT and ethno with the joint development of automatic analysis and indexation tools
    \end{itemize}
  \end{block}
\end{frame}
