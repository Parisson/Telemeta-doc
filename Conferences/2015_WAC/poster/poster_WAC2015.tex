...
\title[Telemeta \& TimeSide]{The Telemeta platform and the TimeSide framework}
\subtitle{Audio archives management and Automatic analysis.}
\author[Fillon, Pellerin]{Thomas Fillon \inst{1}, Guillaume Pellerin\inst{1}}
...
\date[26/01/2015]{26 january 2015}
    ...
    \begin{columns}
      ...
      \begin{column}{0.26\linewidth}
        \begin{center}
          ...
          \colorbox{red!50}{\Large
            \textbf{\url{http://telemeta.org/}}} \vskip1ex
          \colorbox{red!50} { Contact :
...
\tcbset{colback=red!30!white,colframe=red!70!black, leftrule=5mm, width=0.8\linewidth}
\begin{center}
  \begin{tcolorbox}[]\normalsize
    \href{https://github.com/Parisson/TimeSide/}{\raisebox{-.2\height}{\includegraphics[width=1.5cm]{img/misc/GitHub-Mark-120px-plus.png}}\hskip2ex
      \textbf{\texttt{https://github.com/Parisson/TimeSide/}}}
  \end{tcolorbox}
\end{center}
...
\hskip2ex
  ...
  %\begin{column}[T]{0.6\linewidth}
    \hskip2ex
    \begin{beamerboxesrounded}[shadow=true, width=0.9\linewidth]{TimeSide \emph{processing pipe}}
       \centering
...
\begin{block}{Automatic audio analysis}
  \begin{center}
    \includegraphics[width=0.9\linewidth]{img/results/IRIT_Speech4Hz.png}\\
    \includegraphics[width=0.9\linewidth]{img/results/SOLO_DUOdetection.png}
  \end{center}
\end{block}
