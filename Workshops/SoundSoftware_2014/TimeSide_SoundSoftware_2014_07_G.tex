...
\frame{\frametitle{Use cases}
    ...
    \begin{block}{Usages}
        \begin{itemize}
        \item Synchonize large music audio datasets in to a robust and scalable platform
...
\frame{\frametitle{The End}
 \begin{center}
   \large{Thank you!}\\
   \large{We are looking for new collaborations\\ and large scale audio processing use cases. Let's keep in touch!}
   \vspace{0.25cm}
    \begin{block}{Links}
     \begin{itemize}\small
