...
\begin{frame}
 \frametitle{TimeSide}\scriptsize
% ==================================
% --------- Résumé -----------------
% ==================================
\begin{block}{Avancement : Versions 0.4.3 $\rightarrow$ 0.5.3}
  ...
  \item Instalation par paquet Debian
  \item Documentation :  \url{http://files.parisson.com/timeside/doc/} + doctest
  \item Amélioration du code des grapheurs
  \item Amélioration du décodeurs : support de segment d'audio, mise en mémoire de l'audio pour le rejouer \emph{hors-ligne}
  \item Amélioration du code des analyseurs
    \begin{itemize}\footnotesize
      \item Mise en place d'un conteneur pour stocker et sérialiser (hdf5, yaml, json, xml) les résultats des analyses et les annotations
      \item Support de différents modes temporels et de types de résulats
    ...
    \end{itemize}
  \item Mise en place d'un outil en ligne de command : \texttt{timeside-launch}
