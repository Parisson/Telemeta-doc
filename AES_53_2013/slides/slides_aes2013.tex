...
\begin{block}{The project {\tiny(started in 2007)}}
  ...
  \item The CREM laboratory and Parisson are developing an innovative,
    collaborative and interdisciplinary open-source web-based multimedia platform \emph{originally} dedicated to \alert{sound archivists} and \alert{researchers in ethnomusicology}.
